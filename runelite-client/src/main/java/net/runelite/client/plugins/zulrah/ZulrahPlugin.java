...
public class ZulrahPlugin extends Plugin implements KeyListener
{
	...
	public void activatePrayer(Widget prayer) {
		if (client.getWidget(WidgetInfo.BANK_CONTAINER) == null) {
			if (prayer.isHidden() || prayer == null) {
				MenuWasOpen = false;
				...
				if (prayer != null) {
					core.doInvoke(null, prayer.getBounds());
				}
			}
		}
	}
	...
	private void onNpcChanged(NpcChanged event) {
		...
		if (config.prayerHelper() && npcId == 2043 && client.getVar(Prayers.PROTECT_FROM_MISSILES.getVarbit()) != 0) {
			activatePrayer(WidgetInfo.PRAYER_PROTECT_FROM_MISSILES);
		}
		if (config.prayerHelper() && npcId == 2043 && client.getVar(Prayers.PROTECT_FROM_MAGIC.getVarbit()) != 0) {
			activatePrayer(WidgetInfo.PRAYER_PROTECT_FROM_MAGIC);
		}
		if (config.prayerHelper() && npcId == 2042 && client.getVar(Prayers.PROTECT_FROM_MISSILES.getVarbit()) == 0) {
			activatePrayer(WidgetInfo.PRAYER_PROTECT_FROM_MISSILES);

		} else if (config.prayerHelper() && npcId == 2044 && client.getVar(Prayers.PROTECT_FROM_MAGIC.getVarbit()) == 0) {
			activatePrayer(WidgetInfo.PRAYER_PROTECT_FROM_MAGIC);
		}
	...
	private void onNpcSpawned(NpcSpawned event) {
		...
		final int npcId = event.getNpc().getId();
		if (config.prayerHelper() && npcId == 2042 && client.getLocalPlayer().getOverheadIcon() != HeadIcon.RANGED) {
			activatePrayer(WidgetInfo.PRAYER_PROTECT_FROM_MISSILES);
		} else if (config.prayerHelper() && npcId == 2044 && client.getLocalPlayer().getOverheadIcon() != HeadIcon.MAGIC) {
			activatePrayer(WidgetInfo.PRAYER_PROTECT_FROM_MAGIC);
		}
	}
...
enum RotationType
{
	ROT_A("Rotation A", ImmutableList.of(add(ZulrahType.RANGE, ZulrahLocation.NORTH, StandLocation.NORTHEAST_TOP, (StandLocation) null, (Prayers) null, 28), add(ZulrahType.MELEE, ZulrahLocation.NORTH, StandLocation.NORTHEAST_TOP, (StandLocation) null, (Prayers) null, 21), add(ZulrahType.MAGIC, ZulrahLocation.NORTH, StandLocation.EAST_PILLAR_N, StandLocation.EAST_PILLAR_S, Prayers.PROTECT_FROM_MAGIC, 18), add(ZulrahType.RANGE, ZulrahLocation.SOUTH, StandLocation.WEST_PILLAR_N, StandLocation.WEST_PILLAR_N2, Prayers.PROTECT_FROM_MISSILES, 39), add(ZulrahType.MELEE, ZulrahLocation.NORTH, StandLocation.WEST_PILLAR_N, (StandLocation) null, (Prayers) null, 22), add(ZulrahType.MAGIC, ZulrahLocation.WEST, StandLocation.WEST_PILLAR_S, StandLocation.EAST_PILLAR_S, Prayers.PROTECT_FROM_MAGIC, 20), add(ZulrahType.RANGE, ZulrahLocation.SOUTH, StandLocation.EAST_PILLAR, (StandLocation) null, (Prayers) null, 28), add(ZulrahType.MAGIC, ZulrahLocation.SOUTH, StandLocation.EAST_PILLAR, StandLocation.EAST_PILLAR_N2, Prayers.PROTECT_FROM_MAGIC, 36), addJad(ZulrahType.RANGE, ZulrahLocation.WEST, StandLocation.WEST_PILLAR_S, StandLocation.EAST_PILLAR_S, Prayers.PROTECT_FROM_MISSILES, 48), add(ZulrahType.MELEE, ZulrahLocation.NORTH, StandLocation.NORTHEAST_TOP, (StandLocation) null, (Prayers) null, 21))),
	ROT_B("Rotation B", ImmutableList.of(add(ZulrahType.RANGE, ZulrahLocation.NORTH, StandLocation.NORTHEAST_TOP, (StandLocation) null, (Prayers) null, 28), add(ZulrahType.MELEE, ZulrahLocation.NORTH, StandLocation.NORTHEAST_TOP, (StandLocation) null, (Prayers) null, 21), add(ZulrahType.MAGIC, ZulrahLocation.NORTH, StandLocation.EAST_PILLAR_N, StandLocation.EAST_PILLAR_S, Prayers.PROTECT_FROM_MAGIC, 18), add(ZulrahType.RANGE, ZulrahLocation.WEST, StandLocation.WEST_PILLAR_S, (StandLocation) null, (Prayers) null, 28), add(ZulrahType.MAGIC, ZulrahLocation.SOUTH, StandLocation.WEST_PILLAR_N, StandLocation.WEST_PILLAR_N2, Prayers.PROTECT_FROM_MAGIC, 39), add(ZulrahType.MELEE, ZulrahLocation.NORTH, StandLocation.WEST_PILLAR_N, (StandLocation) null, (Prayers) null, 21), add(ZulrahType.RANGE, ZulrahLocation.EAST, StandLocation.CENTER, StandLocation.WEST_PILLAR_S, Prayers.PROTECT_FROM_MISSILES, 20), add(ZulrahType.MAGIC, ZulrahLocation.SOUTH, StandLocation.WEST_PILLAR_S, StandLocation.WEST_PILLAR_N2, Prayers.PROTECT_FROM_MAGIC, 36), addJad(ZulrahType.RANGE, ZulrahLocation.WEST, StandLocation.WEST_PILLAR_S, StandLocation.EAST_PILLAR_S, Prayers.PROTECT_FROM_MISSILES, 48), add(ZulrahType.MELEE, ZulrahLocation.NORTH, StandLocation.NORTHEAST_TOP, (StandLocation) null, (Prayers) null, 21))),
	ROT_C("Rotation C", ImmutableList.of(add(ZulrahType.RANGE, ZulrahLocation.NORTH, StandLocation.NORTHEAST_TOP, (StandLocation) null, (Prayers) null, 28), add(ZulrahType.RANGE, ZulrahLocation.EAST, StandLocation.NORTHEAST_TOP, (StandLocation) null, Prayers.PROTECT_FROM_MISSILES, 30), add(ZulrahType.MELEE, ZulrahLocation.NORTH, StandLocation.WEST, (StandLocation) null, (Prayers) null, 40), add(ZulrahType.MAGIC, ZulrahLocation.WEST, StandLocation.WEST, StandLocation.EAST_PILLAR_S, Prayers.PROTECT_FROM_MAGIC, 20), add(ZulrahType.RANGE, ZulrahLocation.SOUTH, StandLocation.EAST_PILLAR_S, StandLocation.EAST_PILLAR_N2, Prayers.PROTECT_FROM_MISSILES, 20), add(ZulrahType.MAGIC, ZulrahLocation.EAST, StandLocation.EAST_PILLAR_S, StandLocation.WEST_PILLAR_S, Prayers.PROTECT_FROM_MAGIC, 20), add(ZulrahType.RANGE, ZulrahLocation.NORTH, StandLocation.WEST_PILLAR_N, (StandLocation) null, (Prayers) null, 25), add(ZulrahType.RANGE, ZulrahLocation.WEST, StandLocation.WEST_PILLAR_N, (StandLocation) null, Prayers.PROTECT_FROM_MISSILES, 20), add(ZulrahType.MAGIC, ZulrahLocation.NORTH, StandLocation.EAST_PILLAR_N, StandLocation.EAST_PILLAR_S, Prayers.PROTECT_FROM_MAGIC, 36), addJad(ZulrahType.MAGIC, ZulrahLocation.EAST, StandLocation.EAST_PILLAR_N, (StandLocation) null, Prayers.PROTECT_FROM_MAGIC, 35), add(ZulrahType.MAGIC, ZulrahLocation.NORTH, StandLocation.NORTHEAST_TOP, (StandLocation) null, (Prayers) null, 18))),
	ROT_D("Rotation D", ImmutableList.of(add(ZulrahType.RANGE, ZulrahLocation.NORTH, StandLocation.NORTHEAST_TOP, (StandLocation) null, (Prayers) null, 28), add(ZulrahType.MAGIC, ZulrahLocation.EAST, StandLocation.NORTHEAST_TOP, (StandLocation) null, Prayers.PROTECT_FROM_MAGIC, 36), add(ZulrahType.RANGE, ZulrahLocation.SOUTH, StandLocation.WEST_PILLAR_N, StandLocation.WEST_PILLAR_N2, Prayers.PROTECT_FROM_MISSILES, 24), add(ZulrahType.MAGIC, ZulrahLocation.WEST, StandLocation.WEST_PILLAR_N, (StandLocation) null, Prayers.PROTECT_FROM_MAGIC, 30), add(ZulrahType.MELEE, ZulrahLocation.NORTH, StandLocation.EAST_PILLAR_N, (StandLocation) null, (Prayers) null, 28), add(ZulrahType.RANGE, ZulrahLocation.EAST, StandLocation.EAST_PILLAR, (StandLocation) null, Prayers.PROTECT_FROM_MISSILES, 17), add(ZulrahType.RANGE, ZulrahLocation.SOUTH, StandLocation.EAST_PILLAR, (StandLocation) null, (Prayers) null, 34), add(ZulrahType.MAGIC, ZulrahLocation.WEST, StandLocation.WEST_PILLAR_S, (StandLocation) null, Prayers.PROTECT_FROM_MAGIC, 33), add(ZulrahType.RANGE, ZulrahLocation.NORTH, StandLocation.EAST_PILLAR_N, StandLocation.EAST_PILLAR_S, Prayers.PROTECT_FROM_MISSILES, 20), add(ZulrahType.MAGIC, ZulrahLocation.NORTH, StandLocation.EAST_PILLAR_N, StandLocation.EAST_PILLAR_S, Prayers.PROTECT_FROM_MAGIC, 27), addJad(ZulrahType.MAGIC, ZulrahLocation.EAST, StandLocation.EAST_PILLAR_N, (StandLocation) null, Prayers.PROTECT_FROM_MAGIC, 29), add(ZulrahType.MAGIC, ZulrahLocation.NORTH, StandLocation.NORTHEAST_TOP, (StandLocation) null, (Prayers) null, 18)));
	...
	private static ZulrahPhase add(ZulrahType type, ZulrahLocation zulrahLocation, StandLocation standLocation, StandLocation stallLocation, Prayers prayer, int phaseTicks)
	{
	...
	private static ZulrahPhase addJad(ZulrahType type, ZulrahLocation zulrahLocation, StandLocation standLocation, StandLocation stallLocation, Prayers prayer, int phaseTicks)
	{
...
class ZulrahData
{
	...
	public Optional<Prayers> getCurrentPhasePrayer()
	{
		if (ZulrahPlugin.isZulrahReset())
		{
			return Optional.of(Prayers.PROTECT_FROM_MISSILES);
		}
		else if (current != null && current.getAttributes().getPrayer() != null)
		{
			Prayers phasePrayer = current.getAttributes().getPrayer();
			Prayers invertedPhasePrayer = phasePrayer == Prayers.PROTECT_FROM_MAGIC ? Prayers.PROTECT_FROM_MISSILES : Prayers.PROTECT_FROM_MAGIC;
...
class ZulrahAttributes
{
	...
	public ZulrahAttributes(@Nonnull StandLocation standLocation, @Nullable StandLocation stallLocation, @Nullable Prayers prayer, int phaseTicks)
	{
...
class PrayerHelperOverlay extends OverlayPanel
{
	...
	private int prayerToSpriteId(Prayers prayer)
	{
		switch (prayer)
		{
